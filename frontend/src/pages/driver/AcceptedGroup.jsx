...
function AcceptedGroups() {
  ...
  const getRiderName = (member) => {
    ...
    return rider.full_name || rider.name || rider.email || "Rider";
  };

  const getDriverName = (driver) => {
    if (!driver) return "Driver";

    return driver.full_name || driver.name || driver.email || "Driver";
  };
      ...
      <main className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-5 mb-8'>
          <div className='bg-white border border-gray-100 rounded-2xl p-5 shadow-sm'>
            <p className='text-sm text-gray-400'>Accepted Groups</p>

            <h3 className='text-3xl font-extrabold mt-2'>{groups.length}</h3>

            <p className='text-xs text-gray-400 mt-3'>Groups assigned to you</p>
          </div>

          <div className='bg-white border border-gray-100 rounded-2xl p-5 shadow-sm'>
            <p className='text-sm text-gray-400'>Total Riders</p>
            ...
            <p className='text-xs text-gray-400 mt-3'>Across accepted groups</p>
          </div>
          ...
          <div className='bg-[#172033] rounded-2xl p-5 shadow-sm text-white'>
            ...
            <p className='text-xs text-gray-300 mt-3'>Across accepted groups</p>
          </div>
        </div>
        ...
        {!loading && !error && groups.length === 0 && (
          <div className='bg-white border border-gray-100 rounded-2xl p-12 text-center'>
            ...
            <h3 className='text-xl font-extrabold mt-5'>No Accepted Groups</h3>
                ...
                <div className='p-5 sm:p-7'>
                  ...
                  <div className='grid grid-cols-2 lg:grid-cols-4 gap-3 mt-7'>
                    ...
                    <div className='bg-gray-50 rounded-xl p-4'>
                      ...
                      <p className='font-bold mt-2'>{group.totalSeats || 0}</p>
                    </div>
                  </div>
                  ...
                  <div className='mt-7 border-t border-gray-100 pt-6'>
                    <div className='flex items-center justify-between mb-4'>
                      <div>
                        <h3 className='font-extrabold'>Group Members</h3>
                      ...
                      {group.members?.map((member, index) => (
                        ...
                        >
                          <div className='w-10 h-10 rounded-full bg-[#172033] text-white flex items-center justify-center font-bold'>
                            {getRiderName(member).charAt(0).toUpperCase()}
                          </div>

                          <div>
                            <p className='font-bold'>{getRiderName(member)}</p>
