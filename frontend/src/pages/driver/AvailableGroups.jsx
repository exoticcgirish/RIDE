...
function AvailableGroups() {
  ...
  */
  ...
  | status: "ready"
  |
  | Therefore "ready" MUST be treated as available.
  |
  */
  ...
  */
  ...
  const handleAccept = async (
    ...
    try {
      ...
      const response =
        await acceptRideGroup(
          groupId,
        );

      console.log(
        "Accepted group response:",
        response.data,
      );
      ...
      setTimeout(() => {
        navigate(
          "/driver/accepted-groups",
        );
      }, 700);
    } catch (error) {
      console.error(
        "Accept ride group error:",
        error,
      );

      setError(
        error.response?.data?.message ||
          "Unable to accept this ride group.",
      );
    } finally {
      setAcceptingId(null);
    }
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-2 max-w-2xl">
              Find a compatible ride group,
              review the trip details, and
              accept the ride.
            </p>
          </div>
          ...
          groups.length === 0 && (
            <div className="bg-white border border-gray-100 rounded-3xl p-12 sm:p-16 text-center shadow-sm">
              ...
              <p className="text-gray-400 mt-2 max-w-md mx-auto">
                There are currently no ride
                groups waiting for a driver.
